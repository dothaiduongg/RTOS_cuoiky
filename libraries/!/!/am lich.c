...
void tinh_am_lich() // tính am lich tu ngay thang nam duong lich
{
	...
	lr.Word = LUNAR_CALENDAR_LOOKUP_TABLE[(nam-BEGINNING_YEAR)*12+thang -1];
	N_AL_DT_DL = lr.Info.N_AL_DT_DL;
	T_AL_DT_DL = lr.Info.T_AL_DT_DL;
	SN_CT_AL = lr.Info.SN_CT_AL + 29;
	TN_B_THT =  lr.Info.TN_B_THT;

	lr.Word = LUNAR_CALENDAR_LOOKUP_TABLE[(nam-BEGINNING_YEAR)*12+thang];
	N_AL_DT_DL_TT = lr.Info.N_AL_DT_DL;
	T_AL_DT_DL_TT = lr.Info.T_AL_DT_DL;
