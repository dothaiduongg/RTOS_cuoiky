...
#ifndef ds1820_1_d
#define ds1820_1_d dk_bit(DDRB,2)
#define ds1820_1_i dk_bit(PINB,2)
#define ds1820_1_o dk_bit(PORTB,2)
#define ds1820_2_d dk_bit(DDRD,6)
#define ds1820_2_i dk_bit(PIND,6)
#define ds1820_2_o dk_bit(PORTD,6)
#define ds1820_3_d dk_bit(DDRB,5)
#define ds1820_3_i dk_bit(PINB,5)
#define ds1820_3_o dk_bit(PORTB,5)
#endif
#include "ds18b20.h"
...
u8 ds1820_khoi_tao_x3(void)
{
	...
	ds1820_2_d=0;
	_delay_us(68);
	OK_Flag = (ds1820_i&ds1820_1_i&ds1820_2_i);
	_delay_us(422);
	return OK_Flag;
	sei();
}
