...
checkAND[7]= 0B00000001;
checkAND[6]   = 0B00000010;
checkAND[5] = 0B00000100;
checkAND[4]  = 0B00001000;
checkAND[3]  = 0B00010000;
checkAND[2]  = 0B00100000;
checkAND[1]  = 0B01000000;
checkAND[0]  = 0B10000000;
...
void DrawCircle(uint8_t x0, uint8_t y0, uint8_t radius)  //Midpouint8_t circle algorithm
  {
    int f = 1 - radius;
    int ddF_x = 1;
    int ddF_y = -2 * radius;
...
void  DrawBrLine(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1) { // Bresenham Line Algorithm
   int Dx = x1 - x0; 
   int Dy = y1 - y0;
