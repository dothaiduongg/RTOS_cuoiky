...
//#include "global.h"
  ...
  #define SHT_DDR_CLOCK       DDRC     // Port with clock pin
  #define SHT_PORT_CLOCK      PORTC    // Port with clock pin
  #define SHT_PIN_CLOCK       PINC     // Port with clock pin
  #define SHT_DDR_DATA        DDRC     // Port with data pin
  #define SHT_PORT_DATA       PORTC    // Port with data pin
  #define SHT_PIN_DATA        PINC     // Port with data pin
