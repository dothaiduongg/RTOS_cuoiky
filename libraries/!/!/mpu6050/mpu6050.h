...
//definitions
#define mpu6050_gi 0xd0 //MPU6050_ADDR (0xd0) //device address - 0x68 pin low (GND), 0x69 pin high (VCC)
#define mpu6050_doc 0xd1
...
int16_t ax; int16_t ay; int16_t az; int16_t gxd; int16_t gyd; int16_t gzd;
double axg; double ayg; double azg; double gxds; double gyds; double gzds;
void mpu6050_readNormalizeAccel()
{
	mpu6050_getRawData(&ax, &ay, &az, &gxd, &gyd, &gzd);
	axg = ax * 0.000061f * 9.80665f;
	ayg = ay * 0.000061f * 9.80665f;
	azg = az * 0.000061f * 9.80665f;
}
#endif
