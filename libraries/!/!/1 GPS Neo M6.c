...
// 
// // date as ddmmyy, time as hhmmsscc, and age in milliseconds
void get_datetime_m6(unsigned long *date, unsigned long *time, unsigned long *age)
{
  if (date) *date = _date;
  if (time) *time = _time;
}
...
// }
// 
void crack_datetime_m6(int *year, byte *month, byte *day, 
...
#endif
//$GPRMC,122901.00,A,1050.52982,N,10640.27446,E,0.445,,070918,,,A*7B
